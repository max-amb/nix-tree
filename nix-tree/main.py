...
from errors import CrazyError, ConfigurationFileNotFound
...
def start_ui(file_location: str, write_over: bool) -> None:
    ...
    if command:
        ...
        if command[0] == ["home-manager", "sudo"]:
...
def main():
    ...
    if configuration_file.is_file():
        start_ui(args.file_location, args.writeover)
    else:
